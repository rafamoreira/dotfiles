...
# load codestats vars before the plugin
if [ -f ~/codestats_api_key ]; then
  source ~/codestats_api_key
fi
...
alias startkde="xinit ~/.xinitrc kde"
...
export PATH="$HOME/tizlast:$HOME/.local/bin:$PATH"
